      ...
      <section class="space-y-4">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center space-x-3">
            ...
            <button class="flex items-center space-x-1 px-3 py-1 text-[#D52B1E] hover:bg-red-50 rounded text-sm">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <div class="mb-4">
              ...
              <div class="flex items-center space-x-2 mb-3">
                ...
                <span :class="vehicle.type === 'ไฟฟ้า' ? 'bg-red-100 text-[#991B1B]' : 'bg-orange-100 text-orange-800'" 
  ...
  methods: {
    ...
    getStatusClass(status) {
      ...
      if (status === 'พร้อมใช้' || statusLower === 'available') {
        ...
        return 'text-[#B91C1C] bg-red-50 border-red-200'
