  ...
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      ...
      >
        ...
        <span class="font-medium text-sm">{{ showFilters ? 'ซ่อนตัวกรอง' : 'แสดงตัวกรอง' }}</span>
        <svg
...
export default {
  ...
  computed: {
    ...
    hasActiveFilters() {
      return Object.values(this.customFilters).some(value => value !== '' && value !== null && value !== undefined)
    }
  },
  async mounted() {
    if (this.$store) {
