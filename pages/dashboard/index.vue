<template>
  <div class="space-y-6">
    <!-- Welcome Section -->
    <div class="bg-gradient-to-r from-[#D52B1E] to-[#B91C1C] rounded-lg p-6 text-white shadow-lg">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-bold mb-2">ยินดีต้อนรับสู่ระบบจัดการคิว Multi-Brand</h1>
          <p class="text-red-100">จัดการคิวทดลองขับ ISUZU และ BYD ได้อย่างมีประสิทธิภาพ</p>
        </div>
        <div class="hidden md:flex items-center space-x-4">
          <div class="text-center">
            ...
            <div class="text-xs text-red-100 font-medium">ISUZU</div>
          </div>
          <div class="text-2xl text-red-100">+</div>
          <div class="text-center">
            <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center backdrop-blur-sm mb-2">
            ...
            <div class="text-xs text-red-100 font-medium">BYD</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="bg-white border border-red-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
        <div class="flex items-center justify-between mb-4">
          <div class="flex items-center space-x-3">
            <div class="w-12 h-12 bg-[#D52B1E] rounded-lg flex items-center justify-center shadow-sm">
              <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="M14 16H9m10 0h3l-3.333-5.333M21 16v5a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-1M3 16h3m0 0 3.333-5.333M6 16v5a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1m-3-5L10 3h4l3 8M6 11h12"/>
              </svg>
            </div>
          ...
          <nuxt-link
            ...
            class="h-10 px-4 bg-[#D52B1E] text-white text-sm font-medium rounded-lg hover:bg-[#B91C1C] transition-colors flex items-center space-x-1 shadow-sm"
          >
        ...
        <div class="grid grid-cols-3 gap-4">
          <div class="text-center p-3 bg-red-50 rounded-lg">
            <div class="text-2xl font-bold text-[#D52B1E]">{{ isuzuStats.queues }}</div>
            <div class="text-xs text-gray-600 mt-1">คิวทั้งหมด</div>
          </div>
          <div class="text-center p-3 bg-red-50 rounded-lg">
            <div class="text-2xl font-bold text-[#D52B1E]">{{ isuzuStats.stock }}</div>
            <div class="text-xs text-gray-600 mt-1">สต็อกรถ</div>
          </div>
          <div class="text-center p-3 bg-red-50 rounded-lg">
            <div class="text-2xl font-bold text-[#D52B1E]">{{ isuzuStats.staff }}</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <nuxt-link
        to="/dashboard/isuzu/queue"
        class="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-all cursor-pointer group border-l-4 border-[#D52B1E]"
      >
